...
import com.jyp.kill.config.SysConstant;
import com.jyp.kill.service.rabbitmq.*;
import com.jyp.kill.service.IKillService;
import com.jyp.kill.utils.RandomUtil;
import com.jyp.kill.utils.SnowFlake;
...
public class KillService implements IKillService {
    ...
    private void commonRecordKillSuccessInfo(ItemKill kill, Integer userId) throws Exception {
        ...
        //TODO:学以致用，举一反三 -> 仿照单例模式的双重检验锁写法，在插入之前再次判断该用户是否抢到过该商品
